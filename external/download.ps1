...
Download -PackageName 'math-matrices' -Version '1.1'
Download -PackageName 'math-scalars' -Version '1.4'
Download -PackageName 'math-trigonometry' -Version '1.4'
Download -PackageName 'math-non-scalars' -Version '1.1'
Download -PackageName 'math-points' -Version '0.1'
Download -PackageName 'math-vectors' -Version '0.7'
Download -PackageName 'one-zero-functors' -Version '1.6'
Download -PackageName 'trigonometric-functors' -Version '1.0'
